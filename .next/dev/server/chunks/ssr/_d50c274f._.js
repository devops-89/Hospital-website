module.exports = [
"[project]/components/ServicesDental/Services.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '@/public/Pediatric-Dentistry.jpg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/public/Root-Canal-Therapy.jpg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/public/Teeth-Cleaning.jpg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/public/Teeth-Whitening.jpg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/public/Orthodontics.jpg'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
...
;
;
// import DentalImplants from "@/public/Dental-Implants.jpg";
// import EmergencyCare from "@/public/Emergency-Care.jpg";
// import FillingsAndRestorations from "@/public/Fillings-and-Restorations.jpg";
const services = [
    {
...
//# sourceMappingURL=_d50c274f._.js.map